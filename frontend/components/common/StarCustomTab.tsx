import { View, Text, TouchableOpacity, StyleSheet, DimensionValue, Image,SafeAreaView, ImageURISource } from 'react-native'
...
const StarCustomTab : React.FC<CustomTabsProps> = ({label, width, height=30, margin, selected,setSelected, disabled = false, defaultSelected = false,image,tabBorderColor}) => {
  ...
  return (
    <TouchableOpacity style={[styles.tabs, {backgroundColor: chipColor, borderColor: selected !== label ? tabBorderColor ? tabBorderColor: 'red':'white'}]} onPress={handlePress}
    disabled={disabled}>
